...
const FaceLUT = {
  pz: WebGLRenderingContext.TEXTURE_CUBE_MAP_POSITIVE_X,
  py: WebGLRenderingContext.TEXTURE_CUBE_MAP_POSITIVE_Y,
  nx: WebGLRenderingContext.TEXTURE_CUBE_MAP_POSITIVE_Z,
  nz: WebGLRenderingContext.TEXTURE_CUBE_MAP_NEGATIVE_X,
  ny: WebGLRenderingContext.TEXTURE_CUBE_MAP_NEGATIVE_Y,
  px: WebGLRenderingContext.TEXTURE_CUBE_MAP_NEGATIVE_Z
};
